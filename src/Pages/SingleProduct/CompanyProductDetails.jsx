...
const CompanyProductDetails = ({ product }) => {
  return (
    <>
      <div className="mt-4 ">
        <div>
          ...
          <div className="md:grid grid-cols-5 gap-5 items-start">
            <div className="col-span-2 ">
              ...
              <div>{<p>{product?.ProductDetails_Description || ""}</p>}</div>
            </div>
            <div className=" col-span-3   ">
              ...
              <div>{<p>{product?.AboutProduct_Description || ""}</p>}</div>
            </div>
          </div>
          {/* ------Section 2 ----------------------------------- */}
          <div className=" md:grid grid-cols-5">
            <div className="col-span-2 ">
              <div>
                ...
                <div>{<p>{product?.Things_Description || ""}</p>}</div>
              </div>
            </div>
            <div className="col-span-3 pl-4 ">
              ...
              <div>
                <div className="grid grid-cols-2 max-w-xs ">
                  <div className="">
                    <h1 className="text-sm font-Robot font-medium text-black">
                      Power Source :
                    </h1>
                  </div>
                  <div className=" ">
                    <h1 className="text-sm font-Robot font-medium text-[#92929D]">
                      No Power
                    </h1>
                  </div>
                  {/* ----------------------------------------------------- */}
