...
const RelatedProduct = () => {
    ...
    const svgClick = (index) => {
      setClick(prevClickedItems => ({
        ...prevClickedItems,
        [index]: !prevClickedItems[index], // Toggle the click status
      }));
    };
    return (
   <>
   <div className=''>
    ...
    {ProductsCardsArray.map((item,index)=>(
           ...
           <div className="relative ">
            <div className="   bg-white  px-3 relative rounded-md pb-5 h-[270px]">
              <div className="flex justify-center ">
                <img src={item.image} className="w-[304px] h-[180px] pt-3 pb-6" />
              </div>
              <div className="pb-1">
              ...
              <div className="flex items-center justify-between pb-2">
                <h3 className="font-medium 2xl:text-base text-sm font-Robot">{item.name}</h3>
                <span className="font-medium 2xl:text-base text-sm font-Robot">
                  {item.price}
                </span>
              </div>
              ...
              <div
                onClick={() => {
                  /* setClick(isclick === index ? null :index); */ svgClick(index)
                }}
            ...
            <div className="absolute top-[3%] left-0 shadow-xl">
              <div className={`w-min px-4 py-2 rounded-r-md ${item.LabelColor} `}>
...
const settings = {
    ...
    responsive: [
        {
            breakpoint: 1280, // 2xl breakpoint
            settings: {
              slidesToShow: 3, // Adjust the number of slides for 2xl breakpoint
            },
          },
