...
import { add, remove, removeFromCart } from "../../Store/CartSlice.js";
...
const CartProducts = () => {
  ...
  const addQuantity = (item) => {
    dispatch(add(item));
    //This code is used for Adding price on the base of quantity(remaining to add)
    setTotalPrice((prevTotal) => prevTotal + parseFloat(item.Rented_Price));
  };

  const removeQuantity = (item) => {
    dispatch(remove(item));
    //This code is used for Adding price on the base of quantity(remaining to remove)
    setTotalPrice((prevTotal) => prevTotal - parseFloat(item.Rented_Price));
  };
                    ...
                    <tbody>
                      ...
                      THE RADIUS ON LEFT SIDE IS NOT WORK THATS WHY WE USE THIS APPROACH */}
                            ...
                            <td className="px-3 py-3 whitespace-nowrap 2xl:text-base xl:text-xs font-Mont font-semibold text-center">
                              {/* {Bitem.Quantity > 1 ? calculateTotalPrice(Bitem) : Bitem.Rented_Price} */}
                              {calculateTotalPrice(Bitem)}
                            </td>
                            <td className="px-3 py-3 whitespace-nowrap 2xl:text-base xl:text-xs font-Mont font-semibold text-center">
                              <div className="flex items-center gap-1">
                                <div
                                  onClick={() => removeQuantity(Bitem)}
                                  className="border border-[#92929D] rounded-full w-8 h-8 flex items-center justify-center cursor-pointer "
                                >
                                  <svg
                                    width="18"
                                    height="5"
                                ...
                                <div
                                  ...
                                  className="border border-black rounded-full w-8 h-8 flex items-center justify-center cursor-pointer "
                                >
                                  <svg
                                    width="18"
                                    height="16"
                            ...
                            <td className="px-3 py-3 whitespace-nowrap text-sm  text-center rounded-r-lg">
                              ...
                              >
                                {fav[index] ? Bitem.svg : Bitem.svgSelect}
                              </div> */}
                            </td>
                            <td className="px-3 py-3 whitespace-nowrap text-sm  text-center rounded-r-lg">
                              <div
